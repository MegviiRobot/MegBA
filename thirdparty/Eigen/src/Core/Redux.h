...
struct redux_novec_unroller
{
  ...
  EIGEN_DEVICE_FUNC
  static EIGEN_STRONG_INLINE std::remove_const_t<Scalar> run(const Evaluator &eval, const Func& func)
  {
...
struct redux_novec_unroller<Func, Evaluator, Start, 1>
{
  ...
  EIGEN_DEVICE_FUNC
  static EIGEN_STRONG_INLINE std::remove_const_t<Scalar> run(const Evaluator &eval, const Func&)
  {
  ...
  : redux_novec_unroller<Func,Evaluator, 0, Evaluator::SizeAtCompileTime>
{
  ...
  template<typename XprType>
  EIGEN_DEVICE_FUNC static EIGEN_STRONG_INLINE
  std::remove_const_t<Scalar> run(const Evaluator &eval, const Func& func, const XprType& /*xpr*/)
  {
...
public:
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
  std::remove_const_t<CoeffReturnType> coeffByOuterInner(Index outer, Index inner) const
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE std::remove_const_t<typename internal::traits<Derived>::Scalar>
