...
#endif // not EIGEN_PARSED_BY_DOXYGEN
{
  public:
    ...
    EIGEN_DEVICE_FUNC std::remove_const_t<Scalar> sum() const;
    EIGEN_DEVICE_FUNC std::remove_const_t<Scalar> mean() const;
    EIGEN_DEVICE_FUNC std::remove_const_t<Scalar> trace() const;

    EIGEN_DEVICE_FUNC std::remove_const_t<Scalar> prod() const;
    ...
    EIGEN_DEVICE_FUNC
    std::remove_const_t<Scalar> redux(const BinaryOp& func) const;
