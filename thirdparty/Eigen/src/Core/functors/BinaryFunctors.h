...
#endif
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE std::remove_const_t<result_type> operator() (const LhsScalar& a, const RhsScalar& b) const { return a + b; }
...
struct scalar_conj_product_op  : binary_op_base<LhsScalar,RhsScalar>
{
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE std::remove_const_t<result_type> operator() (const LhsScalar& a, const RhsScalar& b) const
...
struct scalar_pow_op  : binary_op_base<Scalar,Exponent>
{
  ...
  EIGEN_DEVICE_FUNC
  inline std::remove_const_t<result_type> operator() (const Scalar& a, const Exponent& b) const { return numext::pow(a, b); }
...
#endif
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const std::remove_const_t<result_type> operator() (const LhsScalar& a, const RhsScalar& b) const { return a - b; }
  template<typename Packet>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const Packet packetOp(const Packet& a, const Packet& b) const
...
#endif
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const std::remove_const_t<result_type> operator() (const LhsScalar& a, const RhsScalar& b) const
...
template<typename BinaryOp> struct bind1st_op : BinaryOp {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const std::remove_const_t<result_type> operator() (const second_argument_type& b) const { return BinaryOp::operator()(m_value,b); }
...
template<typename BinaryOp> struct bind2nd_op : BinaryOp {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const std::remove_const_t<result_type> operator() (const first_argument_type& a) const { return BinaryOp::operator()(a,m_value); }
